...
const IntroSlide: React.FC<SlideProps> = ({ isActive }) => {
  return (
    <div className="flex flex-col items-center justify-center text-center w-full h-full relative overflow-hidden px-4">
      ...
      >
        ...
        >
          <img 
            ...
            alt="ITW Universe" 
            className="h-32 md:h-48 w-auto object-contain drop-shadow-[0_20px_60px_rgba(59,130,246,0.5)]"
          />
        ...
        <div className="flex flex-col items-center leading-none gap-2 md:gap-4">
          <motion.h1 
            className="text-[4rem] md:text-[7rem] lg:text-[9rem] font-[950] tracking-tighter text-white"
          ...
          <motion.div
            className="text-[4rem] md:text-[7rem] lg:text-[9rem] font-[950] tracking-tighter whitespace-nowrap"
            initial={{ opacity: 0, y: 20 }}
            animate={isActive ? { opacity: 1, y: 0 } : {}}
        ...
        <motion.p 
          className="mt-12 text-base md:text-xl text-white/30 font-black tracking-[0.3em] uppercase max-w-2xl leading-relaxed"
          initial={{ opacity: 0 }}
          animate={isActive ? { opacity: 1 } : {}}
          transition={{ delay: 1.2, duration: 1 }}
        >
          The system evolved. The pack grew. <br/>
          <span className="text-blue-400 italic font-bold tracking-normal opacity-60">Wait until you see what we did in 12 months.</span>
        </motion.p>
      </motion.div>
      ...
      >
        <span className="text-[9px] uppercase tracking-[0.5em] text-white/20 font-black mb-2">Scroll to witness</span>
