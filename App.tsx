...
const platformData = {
  ...
  top_closers: [
    ...
    },
    {
      name: "Arun V",
      score: 116,
      avatarUrl: "https://i.pravatar.cc/150?u=arun",
    },
    {
      name: "Neha S",
      score: 104,
    ...
    { id: "intro", content: <IntroSlide isActive={activeSlide === 0} /> },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="EVOLUTION"
          heading="The pack evolved."
          roleColorClass="text-blue-500"
          styleNote="THE PACK GREW STRONGER."
        >
          <StatPair
    ...
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="STRATEGY"
          heading="Pruning for dominance."
          roleColorClass="text-indigo-500"
          styleNote="PRECISION OVER VOLUME."
        >
          <div className="flex flex-col md:flex-row gap-12 items-center w-full">
            <StatCard
              icon={Building2}
              value={platformData.new_brands}
              label="New brands added"
              colorClass="text-indigo-500"
            />
            <ArrowRight className="w-12 h-12 text-white/10 hidden md:block" />
            <StatCard
              icon={UserMinus}
              value={platformData.brands_offloaded}
              label="Brands offloaded"
      ...
      content: (
        ...
        >
          <div className="flex flex-col w-full">
            ...
            <motion.p
              initial={{ opacity: 0 }}
              animate={activeSlide === 3 ? { opacity: 1 } : {}}
              transition={{ delay: 2 }}
              className="text-white/30 text-center font-bold uppercase tracking-widest text-xs mt-8"
            >
              Analyzing ownership across the 2025 fleet
            </motion.p>
          </div>
        </RoleMetricSlide>
      ),
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="EXECUTION"
          heading="Pure execution."
          roleColorClass="text-blue-500"
          styleNote="RESULTS ARE THE ONLY KPI."
        >
          <div className="flex flex-col md:flex-row gap-10 items-stretch w-full justify-start overflow-x-visible">
            <div className="flex items-center gap-10">
              <StatCard
                icon={Calendar}
                value={platformData.total_tasks_created}
            ...
            <div className="flex items-center gap-10">
              <StatCard
                icon={CheckSquare}
                value={platformData.total_tasks_closed}
            ...
            <ProgressRing
              progress={platformData.execution_rate}
    ...
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="NETWORK"
          heading="Sharpening the Rolodex."
          roleColorClass="text-purple-500"
          styleNote="CONNECTIONS ARE CURRENCY."
        >
          <div className="flex flex-col md:flex-row gap-12 items-center w-full">
            <StatCard
              icon={UserPlus}
              value={platformData.new_pocs}
              label="New POCs added in 2025"
              colorClass="text-purple-500"
            />
            <StatCard
              icon={UserMinus}
              value={platformData.pocs_removed}
              label="POCs removed in 2025"
    ...
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="MARKET LEADERS"
          heading="Market-moving inventories."
          roleColorClass="text-indigo-500"
          styleNote="DOMINATING THE SHELF."
        >
          <PodiumLeaderboard
            colorClass="text-indigo-500"
            items={platformData.top_inventories}
          />
        </RoleMetricSlide>
      ),
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="TERRITORIES"
          heading="Dominant territories."
          roleColorClass="text-emerald-500"
          styleNote="GLOBAL FOOTPRINT, LOCAL IMPACT."
        >
          <PodiumLeaderboard
            colorClass="text-emerald-500"
            items={platformData.top_verticals}
          />
        </RoleMetricSlide>
      ),
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="ELITE"
          heading="The deal closers."
          roleColorClass="text-blue-500"
          styleNote="THE GOLD STANDARD."
        >
          <PodiumLeaderboard
            colorClass="text-blue-500"
            items={platformData.top_closers}
          />
        </RoleMetricSlide>
      ),
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="INFLUENCE"
          heading="The Relationship Monarch."
          roleColorClass="text-purple-500"
          styleNote="WHEN YOU ASK, PEOPLE SAY YES."
        >
          <div className="flex flex-col items-center w-full justify-center">
            <PremiumFeatureCard
              title={platformData.monarch_name}
              avatarUrl={platformData.monarch_avatar}
              description="Market dominance isn't a goal, it's the standard. She owned the conversation and turned connections into a high-intent conversion engine."
              value={platformData.monarch_poc_count}
              label="Contacted POC via ITW CRM"
              showBadge={false}
              suffix=""
              colorClass="text-purple-500"
            />
    ...
    },
    {
      ...
      content: (
        <RoleMetricSlide
          ...
          roleLabel="STRUCTURE"
          heading="Organizing the chaos."
          roleColorClass="text-indigo-500"
          styleNote="ARCHITECTS OF GROWTH."
        >
          <div className="flex flex-col gap-12 w-full">
            <div className="flex items-center gap-12">
              <CountUp
                to={platformData.new_inventories}
                className="text-9xl font-black text-white"
              />
              <div className="flex flex-col">
                <span className="text-xl font-black text-indigo-400">
                  Total New Inventories
                </span>
                <span className="text-[10px] uppercase font-black tracking-widest text-white/30">
                  Architecture Scale 2025
                </span>
              </div>
            </div>
            <div className="w-full">
              <PremiumWaveLine isActive={activeSlide === 10} color="#6366f1" />
            </div>
            <DotGrid
              isActive={activeSlide === 10}
              count={platformData.organization_excellence}
            />
          </div>
        </RoleMetricSlide>
      ),
    ...
    <div className="relative h-screen w-full bg-black text-white overflow-hidden">
      ...
      >
        {slides.map((slide, index) => (
          <section
            key={index}
            className="h-screen w-full snap-start snap-always relative flex items-center overflow-hidden"
          >
