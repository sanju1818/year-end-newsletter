...
const App: React.FC = () => {
  ...
  const slides = [
    ...
    { id: 'evolution', content: <RoleMetricSlide isActive={activeSlide === 1} roleLabel="EVOLUTION" heading="The pack evolved." roleColorClass="text-blue-500"><StatPair leftValue={platformData.new_employees} leftLabel="New employees added in 2025" rightValue={platformData.deactivated_employees} rightLabel="Employees deactivated in 2025" colorClass="text-blue-500" /></RoleMetricSlide> },
          ...
          >
            <motion.div
              animate={{
                ...
                height: 8,
                backgroundColor: activeSlide === index ? '#3b82f6' : 'rgba(255, 255, 255, 0.2)',
                boxShadow: activeSlide === index ? '0 0 15px rgba(59, 130, 246, 0.5)' : 'none'
              }}
